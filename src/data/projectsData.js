...
export const projectsData = {
  dataAnalysis: [
    {
      ...
      demoUrl: null,
      githubUrl: 'https://github.com/Abillallib/jamaican_youtube_analytics',
      featured: true,
      status: 'In Progress',
      metrics: {
        videosAnalyzed: '901',
    ...
    },
    {
      ...
      demoUrl: null,
      githubUrl: 'https://github.com/Abillallib/jamaica_stock_data_extractor',
      featured: true,
      status: 'Completed',
      metrics: {
    ...
    },
    {
      ...
      demoUrl: null,
      githubUrl: 'https://github.com/Abillallib/student-survey-sentiment-analysis',
      featured: true,
      status: 'Completed',
      metrics: {
  ...
  aiEngineering: [
    ...
    },
    {
      ...
      demoUrl: 'https://youtube.com/shorts/SuZDRhXUqLE?feature=share',
      githubUrl: null,
      featured: true,
    ...
    },
    {
      ...
      demoUrl: 'https://youtu.be/zJWQ8smWU3o',
      githubUrl: 'https://github.com/Abillallib/text-to-image-generator',
      featured: true,
      status: 'Completed',
      metrics: {
